...
namespace Cyotek.AzureContainerEcho.Client
{
  partial class SettingsDialog
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.accountsTabListPage = new Cyotek.Windows.Forms.TabListPage();
      ...
      this.tabList.Controls.Add(this.accountsTabListPage);
      ...
      // accountsTabListPage
      // 
      this.accountsTabListPage.Name = "accountsTabListPage";
      this.accountsTabListPage.Size = new System.Drawing.Size(602, 506);
      this.accountsTabListPage.Text = "Accounts";
      // 
      // settingsTabListPage
      // 
    ...
    private Cyotek.Windows.Forms.TabListPage accountsTabListPage;
